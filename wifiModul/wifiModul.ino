...
const char* ssid = "serap";    // This is Your Wifi SSID
const char* pwd = "atakanylmz1";   //This is Your WIFi Hotspot Password
...
void setup() {
  Serial.begin(9600);             //For Arduino Serial Communication
  delay(10);
